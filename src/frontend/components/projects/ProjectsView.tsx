        ...
        <div className="mb-6 p-4 bg-matrix-surface rounded-lg border border-matrix-border space-y-3">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              type="button"
              className="px-3 py-2 bg-matrix-bg border border-matrix-border rounded text-gray-300 hover:bg-matrix-surface transition-colors"
            >
              📁
            </button>
          </div>
        ...
        >
          {projects.map((p) => (
            <ProjectCard
              ...
              onDelete={() => {
                if (confirm('Delete project?')) deleteProject.mutate(p.id);
              }}
            />
          ))}
        </div>
